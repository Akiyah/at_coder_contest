...
ruby main.rb < input13.txt > actual/actual13.txt
ruby main.rb < input14.txt > actual/actual14.txt
...
diff actual/actual13.txt expected13.txt
diff actual/actual14.txt expected14.txt
